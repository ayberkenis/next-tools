  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        ...
        <p className="text-neutral-500">Welcome to your Next.js pre-production toolkit.</p>
      </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-2">
        {Icon && <div className="p-2 bg-neutral-100 dark:bg-neutral-800 rounded-md text-neutral-600 dark:text-neutral-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors"><Icon size={20} /></div>}
        <h3 className="font-semibold text-lg group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{title}</h3>
      </div>
