  ...
  useEffect(() => {
    ...
    if (nav) {
      ...
      timelineData.push({
        ...
        duration: nav.domContentLoadedEventEnd - nav.domContentLoadedEventStart || 5,
        color: 'bg-purple-500'
      });
    }
    ...
    if (timelineData.length < 3) {
        timelineData.push({ label: 'Hydration', start: 150, duration: 45, color: 'bg-orange-400' });
        timelineData.push({ label: 'First Contentful Paint', start: 80, duration: 5, color: 'bg-green-500' });
    }
