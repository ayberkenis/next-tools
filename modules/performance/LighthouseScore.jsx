    ...
    <Card title="Lighthouse Estimates (Unofficial)">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Gauge
          ...
          label="Performance"
          color={scores.performance >= 90 ? "green" : "yellow"}
        />
        <Gauge
          value={scores.accessibility}
          label="Accessibility"
          color={scores.accessibility >= 90 ? "green" : "yellow"}
        />
        <Gauge
          value={scores.bestPractices}
          label="Best Practices"
          color={scores.bestPractices >= 90 ? "green" : "yellow"}
        />
        <Gauge
          value={scores.seo}
          label="SEO"
          color={scores.seo >= 90 ? "green" : "yellow"}
        />
      </div>
    </Card>
  );
